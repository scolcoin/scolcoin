...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/scolcoin/>";
    const std::string URL_WEBSITE = "<https://scolcoin.com/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The Scolcoin Developers", 2022)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Scolcoin useful. "
