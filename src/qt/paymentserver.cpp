...
const QString BITCOIN_IPC_PREFIX("scolcoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/scolcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/scolcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/scolcoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click scolcoin: links
...
//
// OSX-specific way of handling scolcoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in scolcoin: URIs
